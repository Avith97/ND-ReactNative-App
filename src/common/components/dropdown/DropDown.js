...
const Dropdown = (props) => {
    ...
    const [selectedItem, setSelectedItem] = useState(data.find((item) => valueExtractor(item) === value) || null);
    ...
    const renderItem = ({ item, index }) => {
        const isSelected = selectedItem && valueExtractor(item) === valueExtractor(selectedItem);
        ...
        <View ref={drpRef} style={[styles.container, containerStyle]}>
            ...
            >
                <TextInput
                    ...
                    style={[
                        styles.textInput,
                        { fontSize: labelFontSize, color: selectedItem ? textColor : baseColor },
                    ]}
